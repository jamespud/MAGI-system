// @ts-nocheck
// Reference snapshot of the original rich mock data (commit dce45f9), preserved
// to document the UI's expected data shape: agents carry toolCalls[]/evidence[]/
// claims[]/vote, events carry message+data, evidence records have url/observation.
// The real backend currently serves thinner shapes (see /agents endpoint) -- this
// file is the target richness to restore. Not imported anywhere; not compiled.
