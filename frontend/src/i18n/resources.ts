...
export const en: Record<string, string> = {
  ...
  'replay.plan': 'Investigation plan',
  'replay.planSave': 'Save plan',
  'replay.planSaving': 'Saving…',
  'replay.planSaved': 'Plan saved',
  'replay.planAdd': '+ Add sub-question',
  'replay.planRemove': 'Remove',
  'replay.planQuestionPlaceholder': 'Sub-question to investigate…',
  'replay.planBackgroundPlaceholder': 'Background / hints (optional)',
...
export const zh: Record<string, string> = {
  ...
  'replay.taskTree': '任务树',
  'replay.plan': '调查计划',
  'replay.planSave': '保存计划',
  'replay.planSaving': '保存中…',
  'replay.planSaved': '计划已保存',
  'replay.planAdd': '+ 添加子问题',
  'replay.planRemove': '移除',
  'replay.planQuestionPlaceholder': '待调查的子问题…',
  'replay.planBackgroundPlaceholder': '背景 / 提示（可选）',
